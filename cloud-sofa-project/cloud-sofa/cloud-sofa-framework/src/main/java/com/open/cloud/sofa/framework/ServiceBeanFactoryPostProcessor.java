...
public class ServiceBeanFactoryPostProcessor implements BeanFactoryPostProcessor,
	...
	private void generateSofaServiceDefinitionOnClass(String beanId, Class<?> beanClass,
													  ...
													  ConfigurableListableBeanFactory beanFactory) {
		if (!AnnotatedElementUtils.hasAnnotation(beanClass, SofaService.class)) {
			return;
		}
		SofaService sofaServiceAnnotation = AnnotatedElementUtils.getMergedAnnotation(beanClass, SofaService.class);
