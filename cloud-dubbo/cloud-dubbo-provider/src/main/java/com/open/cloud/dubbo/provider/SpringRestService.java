...
import com.open.cloud.business.api.RestService;
import com.open.cloud.business.api.User;
...
public class SpringRestService implements RestService {
	...
	public String pathVariables(@PathVariable("p1") String path1,
		...
		logger.info("/path-variables", result);
		return result;
	}
	...
	public User requestBodyMap(@RequestBody Map<String, Object> data,
		...
		logger.info("/request/body/map", param);
		return user;
	}
