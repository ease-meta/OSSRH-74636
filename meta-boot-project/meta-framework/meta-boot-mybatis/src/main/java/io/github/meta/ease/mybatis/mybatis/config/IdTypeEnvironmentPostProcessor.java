package io.github.meta.ease.mybatis.mybatis.config;

import cn.hutool.core.util.StrUtil;
import com.baomidou.mybatisplus.annotation.DbType;
import com.baomidou.mybatisplus.annotation.IdType;
import io.github.meta.ease.common.util.collection.SetUtils;
import io.github.meta.ease.mybatis.mybatis.core.enums.SqlConstants;
...
/**
 * 当 IdType 为 {@link com.baomidou.mybatisplus.annotation.IdType#NONE} 时，根据 PRIMARY 数据源所使用的数据库，自动设置
 *
 * @author 芋道源码
 */
@Slf4j
