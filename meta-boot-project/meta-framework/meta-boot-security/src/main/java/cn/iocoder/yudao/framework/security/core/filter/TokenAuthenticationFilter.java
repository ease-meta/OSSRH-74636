 ...
 * 验证通过后，获得 {@link cn.iocoder.yudao.framework.security.core.LoginUser} 信息，并加入到 Spring Security 上下文
 *
 * @author 芋道源码
 */
...
public class TokenAuthenticationFilter extends OncePerRequestFilter {
     ...
     *
     * @param request  请求
     * @param token    模拟的 token，格式为 {@link cn.iocoder.yudao.framework.security.config.SecurityProperties#getMockSecret()} + 用户编号
     * @param userType 用户类型
