...
public class MetaLoadBalancerClientSpecification {
    ...
    public static class BlockingSupportConfiguration {
        ...
        public ServiceInstanceListSupplier zonePreferenceDiscoveryClientServiceInstanceListSupplier(
            ...
            ServiceInstanceListSupplierBuilder serviceInstanceListSupplierBuilder = ServiceInstanceListSupplier
                    .builder().withBlockingDiscoveryClient().withCaching();
            ServiceInstanceListSupplierBuilder.DelegateCreator delegateCreator = (
                    configurableApplicationContext,
                    serviceInstanceListSupplier) -> new ZonePreferenceServiceInstanceListSupplier(
                    serviceInstanceListSupplier, configurableApplicationContext
                    .getBean(LoadBalancerZoneConfig.class));
            try {
                Field field = serviceInstanceListSupplierBuilder.getClass()
                        .getDeclaredField("creators");
                field.setAccessible(true);
                List<ServiceInstanceListSupplierBuilder.DelegateCreator> delegateCreators = (List<ServiceInstanceListSupplierBuilder.DelegateCreator>) field
                        .get(serviceInstanceListSupplierBuilder);
