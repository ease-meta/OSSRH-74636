package io.github.meta.ease.report.jasperreports.accessible;/*
...
public class AccessibleApp extends AbstractSampleApp
{
	...
	{
		main(new AccessibleApp(), new String[]{"fill"});
	}
	...
	public void fill() throws JRException
	{
		...
		Image image = 
			Toolkit.getDefaultToolkit().createImage(
				JRLoader.loadBytesFromResource("accessible/dukesign.jpg")
				);
		...
		File file = ResourceUtils.getFile("classpath:accessible/reports/AccessibleReport.jasper");
		JasperFillManager.fillReportToFile(file.getCanonicalPath(), parameters);
