  ...
  >
    ...
    <view class="mescroll-body-content mescroll-wxs-content" :style="{ transform: translateY, transition: transition }"
      ...
      <view v-if="mescroll.optDown.use" class="mescroll-downwarp"
        ...
        <view class="downwarp-content" :change:prop="renderBiz.propObserver" :prop="wxsProp">
          ...
          <view class="downwarp-tip">
            <image v-show="downText === '下拉刷新'" style="width:80rpx;height:86rpx"
                   src="/static/loading/hamster.png"></image>
            <image v-show="downText !== '下拉刷新'" style="width:80rpx;height:86rpx"
                   src="/static/loading/hamster.gif"></image>
          </view>
          <!-- {{downText}} -->
        </view>
      </view>
      ...
      <view v-if="mescroll.optUp.use && !isDownLoading && upLoadType!==3" class="mescroll-upwarp"
        ...
        <view v-show="upLoadType===1" :style="{height: upLoadType===1 ? 'auto' : 0}"
