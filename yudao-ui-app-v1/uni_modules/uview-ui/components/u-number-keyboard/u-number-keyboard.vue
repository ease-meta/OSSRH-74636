...
$u-number-keyboard-padding: 8px 10 rpx 8px 10 rpx !default;
$u-number-keyboard-button-width: 222 rpx !default;
$u-number-keyboard-button-margin: 4px 6 rpx !default;
...
$u-number-keyboard-button-height: 90 rpx !default;
