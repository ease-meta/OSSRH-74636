<template>
  <view class="app">
    ...
    <view class="cell b-b">
      ...
      <input class="input" v-model="userInfo.nickname" type="text" maxlength="8" placeholder="请输入昵称"
...
.cell {
  ...
  switch {
    margin: 0;
    transform: scale(0.8) translateX(10 rpx);
  ...
  .checkbox {
    padding: 12 rpx 0 12 rpx 40 rpx;
    font-size: 28 rpx;
    color: #333;
