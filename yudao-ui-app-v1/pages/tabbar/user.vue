  ...
  <view class="app">
    ...
    <view class="order-wrap">
      ...
      <view class="order-list">
        ...
        <view class="item center" @click="navTo('/pages/order/list?current=2', {login: true})" hover-class="hover-gray"
              :hover-stay-time="50">
...
.user-wrapper {
  ...
  .user {
    ...
    .group {
      ...
      padding: 10 rpx 14 rpx;
      margin: 16 rpx 10 rpx; // 10rpx 避免距离昵称太近
      font-size: 20 rpx;
      color: #fff;
...
.order-wrap {
  ...
  .order-header {
    padding: 28 rpx 20 rpx 6 rpx 26 rpx;
