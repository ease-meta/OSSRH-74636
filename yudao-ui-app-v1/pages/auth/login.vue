      ...
      <view class="input-content">
        <u--form labelPosition="left" :model="form" :rules="rules" ref="form" errorType="toast">
          ...
          <u-form-item prop="code" borderBottom v-if="loginType == 'code'">
            ...
            <u-button slot="right" @tap="getCode" :text="uCode.tips" type="success" size="mini"
                      :disabled="uCode.disabled"></u-button>
            <u-code ref="uCode" @change="codeChange" seconds="60" @start="uCode.disabled === true"
                    @end="uCode.disabled === false"></u-code>
          </u-form-item>
...
<script>
import {login, sendSmsCode, smsLogin} from '@/api/system/auth.js'
