package com.open.cloud.leaf.snowflake;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.open.cloud.leaf.core.common.PropertyFactory;
import com.open.cloud.leaf.snowflake.exception.CheckLastTimeException;
...
public class SnowflakeZookeeperHolder {
    ...
    private static final String PREFIX_ZK_PATH = "/snowflake/"
                                                 + PropertyFactory.getProperties().getProperty(
                                                     "leaf.name");
    ...
    public boolean init() {
        try {
            CuratorFramework curator = createWithOptions(connectionString, new RetryUntilElapsed(
                1000, 4), 10000, 6000);
            curator.start();
            ...
            try {
                ...
                properties.load(new FileInputStream(
                    new File(PROP_PATH.replace("{port}", port + ""))));
