package com.open.cloud.workflow.framework.drools.web;


import com.google.gson.Gson;
import com.open.cloud.workflow.framework.drools.bean.Person;
import com.open.cloud.workflow.framework.drools.common.exception.JsonResponse;
import com.open.cloud.workflow.framework.drools.dao.RulesDao;
import com.open.cloud.workflow.framework.drools.service.RuleTableService;
import com.open.cloud.workflow.framework.drools.service.RulesService;
...
public class RulesController {
    ...
    private final static String verify="规则：package com.open.cloud.workflow.framework.drools;\n" +
            "import Person;\n" +
            "rule \"2\"\n" +
            "\twhen\n" +
            "        $p : Person(age < 30);\n" +
