...
public class ActReProcdef implements java.io.Serializable {
    /** 版本号 */
    private static final long serialVersionUID = -2832983106925572066L;
     ...
     * @return 流程修改时间
     */
    public LocalDateTime getResourceTime() {
     ...
     *          流程修改时间
     */
    public void setResourceTime(LocalDateTime resourceTime) {
