...
public class ServiceFactoryBean extends AbstractContractFactoryBean {
	...
	private boolean hasSofaServiceAnnotation() {
		...
		if (!AnnotatedElementUtils.hasAnnotation(implementationClazz, SofaService.class)) {
			return false;
		}

		SofaService sofaService = AnnotatedElementUtils.getMergedAnnotation(implementationClazz, SofaService.class);
