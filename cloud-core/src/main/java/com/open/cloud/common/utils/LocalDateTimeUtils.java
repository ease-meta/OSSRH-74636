...
public class LocalDateTimeUtils {
	...
	public static boolean compare(TemporalAdjuster temporalAdjuster1, TemporalAdjuster temporalAdjuster2) {
		return temporalAdjuster1.equals(temporalAdjuster2);
	}

	public static MonthDay getMonthDay() {
		return MonthDay.from(LocalDate.now());
	}
}
