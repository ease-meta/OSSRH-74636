...
public interface INameConvert {
    ...
    class DefaultNameConvert implements INameConvert {
        ...
        public @Nonnull
        String entityNameConvert(@Nonnull TableInfo tableInfo) {
            return NamingStrategy.capitalFirst(processName(tableInfo.getName(), strategyConfig
                    .entity().getNaming(), strategyConfig.getTablePrefix(), strategyConfig
                    .getTableSuffix()));
        }
        ...
        public @Nonnull
        String propertyNameConvert(@Nonnull TableField field) {
            return processName(field.getName(), strategyConfig.entity().getNaming(),
                    strategyConfig.getFieldPrefix(), strategyConfig.getFieldSuffix());
        }
