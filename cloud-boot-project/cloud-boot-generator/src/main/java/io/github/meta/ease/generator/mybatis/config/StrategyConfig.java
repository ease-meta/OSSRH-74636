...
import io.github.meta.ease.generator.mybatis.config.builder.*;
import io.github.meta.ease.generator.mybatis.config.po.LikeTable;
...
public class StrategyConfig {
    ...
    public void validate() {
        ...
        if (this.getNotLikeTable() != null && this.getLikeTable() != null) {
            throw new IllegalArgumentException(
                    "<strategy> 标签中 <likeTable> 与 <notLikeTable> 只能配置一项！");
        }
    }
    ...
    private boolean tableNameMatches(@Nonnull String matchTableName, @Nonnull String dbTableName) {
        return matchTableName.equalsIgnoreCase(dbTableName)
                || StringUtils.matches(matchTableName, dbTableName);
    }
