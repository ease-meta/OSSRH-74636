...
public class PostgreSqlKeyWordsHandler extends BaseKeyWordsHandler {
    ...
    private static final List<String> KEY_WORDS = new ArrayList<>(Arrays.asList("ALL", "ANALYSE",
            "ANALYZE", "AND", "ANY", "ARRAY", "AS", "ASC",
            "ASYMMETRIC", "AUTHORIZATION", "BINARY",
            "BOTH", "CASE", "CAST", "CHECK", "COLLATE",
            "COLLATION", "COLUMN", "CONCURRENTLY",
            ...
            "LOCALTIME", "LOCALTIMESTAMP", "NATURAL",
            "NOT", "Nonnull", "NULL", "OFFSET", "ON",
            "ONLY", "OR", "ORDER", "OUTER", "OVERLAPS",
            "PLACING", "PRIMARY", "REFERENCES",
            "RETURNING", "RIGHT", "SELECT", "SESSION_USER",
            "SIMILAR", "SOME", "SYMMETRIC", "TABLE",
    ...
    public PostgreSqlKeyWordsHandler(@Nonnull List<String> keyWords) {
        super(new HashSet<>(keyWords));
    }

    public PostgreSqlKeyWordsHandler(@Nonnull Set<String> keyWords) {
        super(keyWords);
    }
