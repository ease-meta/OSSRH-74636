...
import com.boot.generator.mybatis.ITemplate;
import com.boot.generator.mybatis.annotation.IdType;
import com.boot.generator.mybatis.config.INameConvert;
import com.boot.generator.mybatis.config.StrategyConfig;
import com.boot.generator.mybatis.config.po.TableInfo;
import com.boot.generator.mybatis.config.rules.NamingStrategy;
import com.boot.generator.mybatis.function.ConverterFileName;
import com.boot.generator.mybatis.util.ClassUtils;
...
public class Entity implements ITemplate {
    ...
    public static class Builder extends BaseBuilder {
         ...
         * @since 3.5.0
         */
        public Builder addTableFills(@Nonnull IFill... tableFill) {
