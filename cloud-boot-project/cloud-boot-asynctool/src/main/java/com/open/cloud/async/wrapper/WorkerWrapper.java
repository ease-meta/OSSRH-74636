 ...
 */
package com.open.cloud.async.wrapper;

import com.open.cloud.async.callback.DefaultCallback;
import com.open.cloud.async.callback.ICallback;
import com.open.cloud.async.callback.IWorker;
import com.open.cloud.async.exception.SkippedException;
import com.open.cloud.async.executor.timer.SystemClock;
import com.open.cloud.async.worker.DependWrapper;
import com.open.cloud.async.worker.ResultState;
