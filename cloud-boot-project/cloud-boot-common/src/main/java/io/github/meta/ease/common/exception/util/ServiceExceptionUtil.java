package io.github.meta.ease.common.exception.util;
 ...
 * ServiceExceptionConfiguration 2. 异常提示信息，写在 .properties 等等配置文件 3. 异常提示信息，写在 Apollo
 * 等等配置中心中，从而实现可动态刷新 4. 异常提示信息，存储在 db 等等数据库中，从而实现可动态刷新
 */
@Slf4j
public class ServiceExceptionUtil {
    ...
    public static ServiceException exception(ErrorCode errorCode) {
        String messagePattern = MESSAGES.getOrDefault(errorCode.getCode(),
                errorCode.getMsg());
    ...
    public static ServiceException exception0(Integer code, String messagePattern,
                                              Object... params) {
